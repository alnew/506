...
def makeFacebookRequest(baseURL, params = {}):
    ...
    ### Look at the parameters for the Graph API Explorer
...
## Instance variables for class Song:
### figure out which instance variables I will need here - length of song?

## Create a __str__ method for class Song - this should return info about the song clearly, including the length of the song

## Create a song_lst method that creates a list of instances of the class Song

class Song():
	def __init__(self, song_lst):
		# put the instance variables here - not sure what they will be yet
		# look at search tags from sample iTunes from in discussion sections
		# one tag should include the length of the song
	...
	def __str__(self):
		#put the string that that represents info about the song clearly - should include the length of the song
